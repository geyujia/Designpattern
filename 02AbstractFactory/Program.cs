...
namespace _02AbstractFactory
{
    ...
    #region 步骤 5 为 Color 和 Shape 对象创建抽象类来获取工厂
    /// <summary>
    ...
    #region 步骤 6  创建扩展了 AbstractFactory 的工厂类，基于给定的信息生成实体类的对象。
    /// <summary>
    ...
    #region 步骤 7  创建一个工厂创造器/生成器类，通过传递形状或颜色信息来获取工厂
    /// <summary>
